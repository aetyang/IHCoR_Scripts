...
# 4. Author: Anthony O. Etyang. Last update 17 Apr 2024
#5- updates 25 Nov 2023:
    # study_id is extracted as the first 7 characters of the pdf file name (e.g. KEN0001,GAM0001)
...
#7 updates 17 Apr 2024
    # code for extracting serial numbers of spacelabs devices modified to accommodate different format for MRCG machines
    # additional code to generate lists of those with poor quality abpm readings (<70% success rate) and the pdfs that do not have the raw data
    # removed several lines of code that had been present for debugging after confirming that code is working well.
...
pdf_folder_path = "/Users/aetyang/Documents/Work folders/IHCOR Africa/Data/24hABPM/spacelabs_gambia"

# Create an empty list to store filenames of PDFs with less than 70% successful readings
poor_quality_reading_list = []

# Set the path for the output CSV file
output_csv_path = "/Users/aetyang/Documents/Work folders/IHCOR Africa/Data/24hABPM/output/spacelabs_results2_gambia.csv"
...
for pdf_file in pdf_files:
    if pdf_file.endswith(".pdf"):
        ...
        #  e.g.  print("Start Date:", start_date_match.group(1) if start_date_match else None)
...
if poor_quality_reading_list:
    ...
    poor_quality_reading_list_df.to_csv("/Users/aetyang/Documents/Work folders/IHCOR Africa/Data/24hABPM/output/poor_quality_reading_list_gambia.csv", index=False)
...
if raw_tables_missing_list:
    ...
    raw_tables_missing_list_df.to_csv("/Users/aetyang/Documents/Work folders/IHCOR Africa/Data/24hABPM/output/raw_tables_missing_list_gambia.csv", index=False)
